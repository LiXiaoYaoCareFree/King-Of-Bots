    ...
    <section class="wrapper">
      <div class="container">
        <div id="scene" class="scene" data-hover-only="false">
          ...
          <div class="three" data-depth="0.4">
            <div class="content">
              <span class="piece"></span>
              <span class="piece"></span>
              <span class="piece"></span>
          ...
          <p class="p404" data-depth="0.5">404</p>
        ...
        <div class="text">
          <article>
            ...
            <button @click="goHome">I dare!</button>
          </article>
        </div>
      </div>
    </section>
